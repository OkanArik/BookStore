...
namespace WebApi.Controllers
{
    ...
    public class AuthorController : ControllerBase
    {
        ...
        [HttpPost]
        public IActionResult AddAuthor([FromBody] CreateAuthorCommandModel addAuthor)
        {
        ...
        [HttpPut("{id}")]
        public IActionResult UpdatedAuthor(int id,[FromBody] UpdateAuthorCommandModel updateAuthor)
        {
        ...
        [HttpDelete("{id}")]
        public IActionResult DeletedAuthor(int id)
        {
